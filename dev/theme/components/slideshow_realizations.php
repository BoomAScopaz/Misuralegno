<section class="slideshow_realizations">
	<div class="bg-dark xl:pt-[10rem] md:pt-[6rem] pt-[3rem] pb-[3.5rem]">
		<div class="container flex lg:flex-row flex-col justify-between items-center">
			<div class="md:text-[2.75rem] text-[2.5rem] leading-[1.2] font-bold lg:text-left text-center">
				<?= $args['titolo'] ?>
			</div>
				
			<div class="shrink-0 mt-5 lg:mt-0">
	...
	<div class="flex justify-center items-center mt-[2rem] gap-[1rem]">
