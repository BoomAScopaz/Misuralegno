<section class="hero_home relative text-white bg-light">
	...
	<div class="lg:container mx-auto relative z-[2]">
		...
		<div class="relative">
			...
			<!-- title -->
			<div class="absolute left-0 xl:bottom-[16%] bottom-[50%] w-full flex flex-col items-center text-center xl:translate-y-0 translate-y-[50%]">
