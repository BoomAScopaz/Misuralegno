<section class="home_intro appear-up">
	<div class="container xl:pt-[6rem] md:pt-[4rem] py-[3.5rem]">
		<div class="grid md:grid-cols-12 lg:gap-[3rem] md:gap-[2rem] gap-[1.5rem] items-center">
			<div class="2xl:col-span-5 md:col-span-6 relative flex md:justify-end anim-el">
			...
			<div class="2xl:col-span-7 md:col-span-6 lg:pl-[3rem] anim-el">
				<?= $args['text'] ?>
